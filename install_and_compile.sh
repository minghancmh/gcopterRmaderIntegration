...
wget https://github.com/CGAL/cgal/releases/download/releases%2FCGAL-4.14.2/CGAL-4.14.2.tar.xz --no-check-certificate
...
##########################################
cd ~/src/GCOPTER && git submodule init && git submodule update && cd ../../
