...
#include <rmader_msgs/PieceWisePolTraj.h>
...
namespace mu
{
static constexpr int red_normal = 1;  // mc \equiv rmader colors
...
mt::PieceWisePol pwpMsg2Pwp(const rmader_msgs::PieceWisePolTraj& pwp_msg);
rmader_msgs::PieceWisePolTraj pwp2PwpMsg(const mt::PieceWisePol& pwp);
