...
rmader_msgs::PieceWisePolTraj mu::pwp2PwpMsg(const mt::PieceWisePol& pwp)
{
  rmader_msgs::PieceWisePolTraj pwp_msg;
  ...
  {
    rmader_msgs::CoeffPoly3 coeff_poly3;
...
mt::PieceWisePol mu::pwpMsg2Pwp(const rmader_msgs::PieceWisePolTraj& pwp_msg)
{
  mt::PieceWisePol pwp;
